...
namespace NetworkMonitor
{
    ...
    )
    {
        ...
        m_websocket.async_write(
            ...
            [onSend](boost::beast::error_code ec, std::size_t bytesTransferred){ onSend(ec) ;}
        );
    }
    ...
    WebSocketClient::Close(CloseHandler onClose /*= nullptr*/)
    {
        ...
        m_websocket.async_close(boost::beast::websocket::close_code::normal,
            [onClose](auto ec) { onClose(ec); }
        );
    }


    void
    WebSocketClient::_onResolve(
    ...
    WebSocketClient::_onConnect(boost::beast::error_code ec)
    {
        ...
        m_websocket.async_handshake(
            m_url, "/",
            [this](boost::beast::error_code ec) { _onHandshake(ec); }
        );
    }
